...
const SilverCorporateGifts = () => {
  const PAGE_TITLE = "Corporate Gifts";
  const SUBCATEGORY = "Corporate Gifts";
  const PARENT_CATEGORY = "Gifts";
  const PARENT_PATH = "/gifts";
...
export default SilverCorporateGifts;

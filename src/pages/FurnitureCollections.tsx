          ...
          {showSearch ? (
            ...
            <div className="flex items-center justify-between px-4 py-3">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-lg font-semibold text-gray-900 dark:text-zinc-100">Furniture Collections</h1>
              </div>
          ...
          <div className="container-custom px-4">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-gray-500 dark:text-zinc-500 text-sm">No furniture items found</p>
                {searchQuery && (
                  <button

...
const SilverCandleStands = () => {
  const PAGE_TITLE = "Candle Stands";
  const SUBCATEGORY = "Candle Stands";
  const PARENT_CATEGORY = "Home Decor";
  const PARENT_PATH = "/home-decor";
...
export default SilverCandleStands;
